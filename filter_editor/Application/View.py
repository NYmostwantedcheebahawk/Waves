...
class dashboard(QMainWindow):
   ...
   def __init__(self):
       ...
       self.manual_modification = QAction("add manual modification", self)
       ...
       self.actions.addAction(self.manual_modification)
   ...
   def define(self):
       ...
       self.layout_text.addWidget(self.widget.handicap_frequency_label)
       self.layout_text.addWidget(self.widget.handicap_frequency)
       self.layout_text2.addWidget(self.widget.handicap_impulsion_label)
       self.layout_text2.addWidget(self.widget.handicap_impulsion)
...
class dashboard_content(QWidget):
    ...
    def __init__(self):
        ...
        self.handicap_frequency_label = QLabel("Handicap Frequency")
        self.handicap_frequency = QLineEdit()
        self.handicap_impulsion_label = QLabel("Handicap Impulsion")
        self.handicap_impulsion = QLineEdit()
