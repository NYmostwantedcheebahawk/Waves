...
class transfer_function():
    ...
    def __init__(self, cutoff1,cutoff2, order, resolution, resolutiondb,frequency_handicap, impulsion_handicap, phase_handicap, type, frequency_min, frequency_middle, frequency_max, impulsion_first, impulsion_middle, impulsion_last,proportioned_filter =None,manual_modification = None):
        self.name = "transfer_function"
        self.cutoff1 = cutoff1
        self.cutoff2 = cutoff2
        self.order = order
        self.frequency_handicap = frequency_handicap
        self.impulsion_handicap = impulsion_handicap
        self.phase_handicap = phase_handicap
        ...
        if(manual_modification != None):
            self.manual_modifications = [manual_modification]
        else:
            self.manual_modifications = None
    ...
    def __plug__(self, transfer_function):
        ...
        self.frequency_handicap = transfer_function.frequency_handicap
        self.impulsion_handicap = transfer_function.impulsion_handicap
        self.phase_handicap = transfer_function.phase_handicap
    ...
    def __modify_frequency_handicap__(self, frequency_handicap):
        self.frequency_handicap = frequency_handicap

    def __modify_impulsion_handicap__(self, impulsion_handicap):
        self.impulsion_handicap = impulsion_handicap

    def __modify_phase_handicap__(self, phase_handicap):
        self.phase_handicap = phase_handicap
    ...
    def __insert_manual_modification__(self, manual_modification):
        if(self.manual_modifications == None):
            self.manual_modifications = [manual_modification]
        else:
            self.manual_modifications.insert(-1, manual_modification)
