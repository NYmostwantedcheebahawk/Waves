class plot_editor_calculator():
    ...
    def passe_bas_bode(self,transfer_function,filter_equations,frequency_handicap,impulsion_handicap,resolution,impulsion,freq):
    ...
    def passe_haut_bode(self,transfer_function,filter_equations,frequency_handicap,impulsion_handicap,resolution,impulsion,freq):
    ...
    def proportioned_filter_phase(self, proportioned_filter,impulsion,freq,resolution,filter_equations):
        for x in range(0, len(proportioned_filter)):
            for e in range(
    ...
    def passe_bas_phase(self,transfer_function,filter_equations,frequency_handicap,impulsion_handicap,resolution,impulsion,freq):
        for x in range(transfer_function.frequency_min, (transfer_function.frequency_max * resolution)):
            modification_was_made = False
            if (transfer_function.manual_modifications != None):
                for o in range(0, len(transfer_function.manual_modifications)):
